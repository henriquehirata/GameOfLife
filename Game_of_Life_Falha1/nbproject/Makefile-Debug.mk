...
${OBJECTDIR}/src/include/Model.o: src/include/Model.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/include/Model.o src/include/Model.cpp

${OBJECTDIR}/src/cpp/Main.o: src/cpp/Main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cpp/Main.o src/cpp/Main.cpp

${OBJECTDIR}/src/cpp/View.o: src/cpp/View.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cpp/View.o src/cpp/View.cpp

${OBJECTDIR}/src/cpp/Statistics.o: src/cpp/Statistics.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cpp/Statistics.o src/cpp/Statistics.cpp

${OBJECTDIR}/src/cpp/GameOfLife.o: src/cpp/GameOfLife.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cpp/GameOfLife.o src/cpp/GameOfLife.cpp
